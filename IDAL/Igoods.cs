   ...
   public  interface Igoods
    {
        ...
        DataTable SelectStoreID(int ID,int type_id);
        DataTable SelectHotgoods();
        DataTable selectMallBike(int type_id);
        DataTable SelectShoppingCart(int user_id);
        int InsertShoppingCart(shoppingcart Shoppingcart);
        int DeleteShoppingCart(int ShoppingCartID);
        DataTable SelectAllTotalAmount(int user_id);
        ...
        int InsertIndent(int UserID, DateTime startt, DateTime endt); //从购物车表插入订单表
