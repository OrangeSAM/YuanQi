			...
			<div class="login_form">
               ...
               <div class="inputOuter" id="pArea">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="密码不能为空！" ControlToValidate ="p" Display ="Dynamic" ValidationGroup ="submitGroup"></asp:RequiredFieldValidator>
                    ...
                    <asp:Button ID="submit" runat="server" Text="登 录" style="margin-top:20px;width:150px;text-align :center;margin-left :65px; " CssClass ="button_blue "  OnClick ="Submit_Click" ValidationGroup ="submitGroup"/>
